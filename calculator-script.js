...
document.querySelector('.loan-form').addEventListener('submit', function (event) {
    ...
    paymentAmountElement.textContent = monthlyPayment.toLocaleString(undefined, {
      maximumFractionDigits: 0
    }) + ' SEK';
  });
  
  // Reset form handler
  document.querySelector('.loan-form button[type="reset"]').addEventListener('click', function() {
